;!function(exports, undefined) {
  ...
  exports.EventEmitter2___old = EventEmitter2___old;

  function EventEmitter2___old(conf) {
    conf = conf || {};
    if (conf.delimiter === '*') {
  ...
  EventEmitter2___old.prototype.addListener = function(event, listener) {
  ...
  EventEmitter2___old.prototype.on = EventEmitter2___old.prototype.addListener;

  EventEmitter2___old.prototype.once = function(event, listener) {
    this.many(event, 1, listener);
  };

  EventEmitter2___old.prototype.many = function(event, ttl, listener) {
  ...
  EventEmitter2___old.prototype.emit = function(event) {
  ...
  EventEmitter2___old.prototype.removeListener = function(event, listener) {
  ...
  EventEmitter2___old.prototype.removeAllListeners = function(){ this._events = {}; };

  EventEmitter2___old.prototype.setMaxListeners = function(n) {
    this.maxListeners = n;
  };

  EventEmitter2___old.prototype.listeners = function(event) {
  ...
  EventEmitter2___old.prototype.nameError = function() {
