...
;!function(undefined) {
  ...
  Object.assign(TargetObserver.prototype, {
    subscribe: function(event, localEvent, reducer){
      ...
      if(emitter._newListener && emitter._removeListener && !observer._onNewListener){
        ...
        this._onRemoveListener= function(event){
          if(!emitter.hasListeners(event) && listeners[event]){
            listeners[event]= null;
            this._off.call(target, event, handler);
          }
        };
  ...
  EventEmitter.prototype.hasListeners = function (type) {
    ...
    return !!(_all && _all.length || _events && (type === undefined ? Object.keys(_events).length : _events[type]));
  };
