...
'3. Add two listeners on an single event and emit the event.': function (test) {
...
'4. Add two listeners on an single event and emit the event twice.': function (test) {
...
'5. Add two listeners on an single event and emit the event with a parameter.': function (test) {
...
'6. Add two listeners on an single event and emit the event twice with a parameter.': function (test) {
...
'3. Add a listener on an event and emit the event with a value.': function (test) {
  var emitter = this.emitter;
